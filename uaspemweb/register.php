...
<body>
    <div class="containerregister">
        <div class="judulregister">Ruang Desa Atlas</div>
        ...
        if(isset($_POST['submit'])){
            ...
            if(mysqli_num_rows($verify_query) !=0 ){
                echo "<div class='message'>
                        <p>Email ini sudah digunakan, gunakan email lain</p>
                    </div> <br>";
        ...
        ?>
            ...
            <form action="" method="post">
                ...
                <div class="field input">
                    ...
                    <input type="text" name="email" id="email" autocomplete="off" placeholder="masukan email anda"  required>
                </div>
                
                <div class="field input">
                    <label for="age">Umur</label>
                    <input type="number" name="age" id="age" autocomplete="off" placeholder="masukan umur anda" required>
                </div>
